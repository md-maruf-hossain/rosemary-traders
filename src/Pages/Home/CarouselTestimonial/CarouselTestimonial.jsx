  ...
  return (
    <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8 w-2/4">
      ...
      <div className="relative w-full glide-08">
        {/*    <!-- Slides --> */}
        <div className="overflow-hidden text-center bg-white rounded shadow-2xl text-slate-500 shadow-slate-200 " data-glide-el="track">
                  ...
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-loose lg:text-xl">
                        <p>Rosemary Traders transformed my business with their unique products. The quality is unmatched, and the service is exceptional.</p>
                      </blockquote>
                      <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-teal-500">
                        ...
                        <div className="flex items-center gap-4 pt-4 text-sm text-left text-teal-500">
                          <div className="flex flex-col gap-1">
                            <span className="font-bold uppercase">Sarah M</span>
                          </div>
                        </div>
                      </figcaption>
                    </figure>
              ...
              <div className="w-full">
                ...
                <div className="overflow-hidden">
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-loose lg:text-xl">
                        <p>I love the variety of spices and cosmetics they offer. It's like having a piece of the world in my kitchen and on my vanity!</p>
                      </blockquote>
                      <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-teal-500">
                        <span className="flex gap-1 text-amber-400" role="img" aria-label="Rating: 3 out of 5 stars">
                          <span aria-hidden="true">
                        ...
                        <div className="flex items-center gap-4 pt-4 text-sm text-left text-teal-500">
                          <div className="flex flex-col gap-1">
                            <span className="font-bold uppercase">John D</span>
                          </div>
                        </div>
                      </figcaption>
                    </figure>
                ...
                <div className="overflow-hidden">
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-loose lg:text-xl">
                        <p>
                          I'm so impressed with the range of hair oils they offer. It’s like giving my hair a luxurious treat every time I use them. Each oil has its own unique benefits, making my
                          hair care routine feel truly pampering and effective!
                        </p>
                      </blockquote>
                      <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-teal-500">
                        <span className="flex gap-1 text-amber-400" role="img" aria-label="Rating: 3 out of 5 stars">
                        ...
                        <div className="flex items-center gap-4 pt-4 text-sm text-left text-teal-500">
                          <div className="flex flex-col gap-1">
                            <span className="font-bold uppercase">Iftekhar</span>
                          </div>
                        </div>
                      </figcaption>
                    </figure>
                ...
                <div className="overflow-hidden">
                  <div className="relative p-6">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-loose lg:text-xl">
                        <p>
                          I'm amazed by the incredible variety of foods they offer. It’s like a culinary journey around the world from the comfort of my home. Each dish brings a new flavor experience
                      ...
                      <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-teal-500">
                        ...
                        <div className="flex items-center gap-4 pt-4 text-sm text-left text-teal-500">
                          <div className="flex flex-col gap-1">
                            <span className="font-bold uppercase">Rahim</span>
                          </div>
                        </div>
                      </figcaption>
                    </figure>
        ...
        {/*    <!-- Indicators --> */}
        <div className="flex items-center justify-center w-full gap-2 pt-6" data-glide-el="controls[nav]">
